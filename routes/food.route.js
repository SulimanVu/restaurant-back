...
router.post("/", authMiddleware, uploadImages.array("image") ,foodController.createFood);
...
router.patch("/edit", authMiddleware, uploadImages.array("image"), foodController.editFood)
